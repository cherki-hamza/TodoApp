...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title style="color:brown;">Todo App</title>
        <style>
            body {
                display: flex;
                align-items: center;
...
{{--        </div>--}}
            ...
            <div class="container">
                <div class="col-md-12">
                    <h1 class="text-success text-center my-5">cherki hamza todo Application</h1>
                    <div class="row">
                        <div class="col-md-8">
                            <div class="anim">
                        ...
                        <div class="col-md-4">
                            <div class="float-right">
                                <div class="my-2">
                                    <span><a href="{{route('todos.index')}}" class="btn btn-warning text-primary font-weight-bolder"><i class="fa fa-home"></i>Enter to App</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
